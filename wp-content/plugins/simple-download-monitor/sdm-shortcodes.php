...
function sdm_register_shortcodes() {
    ...
    add_shortcode('sdm-download', 'sdm_create_download_shortcode_2');  // For download shortcode (for backwards compatibility)
...
function sdm_create_download_shortcode($atts) {
    ...
    if (empty($button_text)) {//Use the default text for the button
        $button_text_string = __('Descargar', 'sdm_lang');
...
/*********************************************************************************/
function sdm_create_download_shortcode_2($atts) {
