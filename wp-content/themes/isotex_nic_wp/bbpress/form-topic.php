...
<?php if ( bbp_is_topic_edit() ) : ?>
	...
	<?php bbp_topic_tag_list( bbp_get_topic_id(), array( 'before' => '<div class="bbp-topic-tags"><p>' . esc_html__( 'Tags:', 'corporative' ) . '&nbsp;', 'sep' => ' ' ) ); ?>
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button small submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
