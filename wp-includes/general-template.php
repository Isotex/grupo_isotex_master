		...
		if ( 'html5' == $format ) {
			...
			$form = '<form role="search" method="get" class="search-form" action="' . esc_url( home_url( '/' ) ) . '">
				...
				<label>
					...
					<input type="search" class="search-field" placeholder="' . esc_attr_x( 'Busqueda', 'placeholder' ) . '" value="' . get_search_query() . '" name="s" title="' . esc_attr_x( 'Buscar Por:', 'label' ) . '" />
			...
			$form = '<form role="search" method="get" id="searchform" class="searchform" action="' . esc_url( home_url( '/' ) ) . '">
				...
				<div>
					...
					<label class="screen-reader-text" for="s">' . _x( 'Buscar Por:', 'label' ) . '</label>

					<input type="text" value="' . get_search_query() . '" name="s" id="s" />

					<input type="submit" id="searchsubmit" value="'. esc_attr_x( 'Buscar', 'submit button' ) .'" />
